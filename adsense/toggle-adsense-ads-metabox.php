...
class toggle_adsense_ad_metabox{
    ...
    public function save( $post_id, $post, $update ){
        ...
        if( defined("DOING_AUTOSAVE") && DOING_AUTOSAVE ){
       	...
       	$value = (isset($_POST['show_adsense_ad']) && $_POST['show_adsense_ad']=='on') ? 'show' : 'hide';
    ...
    public function render_meta_box( $post ){
        ...
        ?>
			<div class="theAccordion">
				<input type="checkbox" id="show-adsense-ad" name="show_adsense_ad" 
